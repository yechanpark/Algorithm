...
public class CountAndSayStringBuilderTest {
    private CountAndSayStringBuilder countAndSayStringBuilder;

    @BeforeEach
    public void init() {
        this.countAndSayStringBuilder = new CountAndSayStringBuilder();
    }

    @Test
    public void sample1Test() {
        int n  = 1;
        String actual = countAndSayStringBuilder.solution(n);
        String expected = "1";
